...
package com.bonc.mobile.plugin.scancoder.zxing.camera;
...
public final class CameraManager {
	...
	/**
	 * Opens the capture_activity_layout driver and initializes the hardware parameters.
	 * 
	 * @param holder
	 *            The surface object which the capture_activity_layout will draw preview frames
	 *            into.
	 * @throws IOException
	 *             Indicates the capture_activity_layout driver failed to open.
	 */
	...
	/**
	 * Closes the capture_activity_layout driver if still in use.
	 */
	...
	/**
	 * Asks the capture_activity_layout hardware to begin drawing preview frames to the screen.
	 */
	...
	/**
	 * Tells the capture_activity_layout to stop drawing preview frames.
	 */
