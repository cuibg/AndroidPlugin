...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(CaptureActivity.this, getResources().getString(R.string.qrcode_scan_error), Toast.LENGTH_SHORT)
					.show();
		} else {
					...
					try {
						...
						if (!TextUtils.isEmpty(uri.getAuthority())) {
							Cursor cursor = getContentResolver().query(uri,
									...
									null, null, null);
							if (null == cursor) {
								Toast.makeText(this, getResources().getString(R.string.qrcode_find_img_error), Toast.LENGTH_SHORT)
										.show();
								return;
							}
							cursor.moveToFirst();
						...
						mProgress.setMessage(getResources().getString(R.string.qrcode_scaning_prompt));
						...
						Toast.makeText(CaptureActivity.this, getResources().getString(R.string.qrcode_analysy_error),
			...
			switch (msg.what) {
				case 1:
					...
					if ("".equals(resultString)) {
						Toast.makeText(CaptureActivity.this, getResources().getString(R.string.qrcode_scan_error),
				...
				case 2:
					mProgress.dismiss();
					Toast.makeText(CaptureActivity.this, getResources().getString(R.string.qrcode_analysy_error), Toast.LENGTH_LONG)
							.show();
