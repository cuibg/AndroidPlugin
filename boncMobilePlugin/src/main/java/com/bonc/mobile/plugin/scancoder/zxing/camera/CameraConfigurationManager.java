...
final class CameraConfigurationManager {
	...
	/**
	 * Reads, one time, values from the capture_activity_layout that are needed by the app.
	 */
	...
	/**
	 * Sets the capture_activity_layout up to take preview images which are used for both preview
	...
	private static Point getCameraResolution(Camera.Parameters parameters,
		...
		if (cameraResolution == null) {
			// Ensure that the capture_activity_layout resolution is a multiple of 8, as the
			// screen may not be.
