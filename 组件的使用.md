...
2. 监听当前短信获取
  ...
  ``` android 
	SmsContentObserver smsContentObserver = new SmsContentObserver(this, new Handler(), "18511860807");//最后一个参数如果传null，或者是"",将监听所有的短信
        smsContentObserver.setMsgContentListenr(new SmsContentObserver.MsgContentListener() {
            @Override
